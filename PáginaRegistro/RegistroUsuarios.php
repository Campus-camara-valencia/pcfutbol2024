...
<body class="flex flex-col items-center justify-center min-h-screen bg-gray-800 p-4">
        ...
        <form action="" method="post" class="w-full max-w-3xl">
            <div class="mb-6">
                ...
                <input type="text" name="Nombre" id="name" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" placeholder="Introduce tu nombre" required/>
            </div>
            ...
            <div class="mb-6">
                ...
                <input type="text" name="pass" id="pass" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" placeholder="Introduce la contraseña" required/>
            </div>
